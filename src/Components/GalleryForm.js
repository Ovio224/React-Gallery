  ...
  render() {
    ...
    return (
      <div className="photo-container">
        ...
        <button className="btn-order" onClick={this.props.handleSort}>
          Order By Title
        </button>
        <ul>
          {pictures ? (
            pictures // display either the pictures or no results
          ) : (
        ...
        <button className="btn-order" onClick={this.handleClick}>
          Show More
        </button>
        {names ? (
          <span className="footer">
            {' '}
            Ovi &copy; Oh, I can see that you are liking <strong>{names}s</strong>, aren't you?
          </span>
        ) : (
          <span className="footer">
            {' '}
            Hello there, I hope you like <strong>pictures</strong>. Go ahead, search for something!
          </span>
        )}
      </div>
    );
